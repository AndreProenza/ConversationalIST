...
*/
        ...
        Cursor cursor = db.rawQuery("select * from " + FeedReaderContract.FeedEntry.CHANNELS_TABLE_NAME,null);
...
// Create a new map of values, where column names are the keys
        ...
        values.put(FeedReaderContract.FeedEntry.KEY_CHANNEL_NAME, "Canal de teste: " + id);
